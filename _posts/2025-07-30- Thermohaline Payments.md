...
title: Thermohaline Payments

tags: [AI_Data, Product, Payments, Banking_FS]
...
> (**_Thermohaline circulation shifts** → changes in deep currents driven by temperature (thermo) and salinity (haline)_)
...
I've been doing more work on AI and [Product](https://kevanchristmas.github.io/2025/04/29/AI-and-product-II/). Post that, and including a few discussions, I've seen some Payments companies and banks I've work/ed with using Gen AI for fraud detection, routing optimisation, and compliance. Also I thought more about the end of inertia as a business model in financial services (linked in the AI x Product piece) - think loyalty points, non/low-interest bearing deposits etc. - so it seemed it might be time to *deep-dive* (_sic._) further into the sea of payments.
